...
echo This Script Was Made By kishansome >update.kishansome
...
echo -e "\e[4;32m   YouTube Page: https://www.youtube.com/c/Kishan Some \e[0m"
echo " "
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By Kishan'> call.xxx
...
git clone https://github.com/kishan.some/TBomb.sh
if [[ -s TBomb/TBomb.sh ]];then
cd TBomb
cp -r -f * .. > temp
cd ..
rm -rf  TBomb >> temp
rm update.kishansome >> temp
rm temp
chmod +x TBomb.sh
fi
...
echo -e "\e[1;33m      [*]  kishansome   \e[1;31m"
echo "         [-] Mail At: kishansome@gmail.com"
echo -e "\e[1;33m      [*]  The Black Hacker Roxstar   \e[1;31m"
echo "         [-] Ping At: http://wa.me/918837403193"
